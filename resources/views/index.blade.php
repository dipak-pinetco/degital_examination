            ...
            <div class="relative bg-gray-900">
                ...
                <div
                    ...
                    <div class="relative pt-12 pb-64 sm:pt-24 sm:pb-64 xl:col-start-1 xl:pb-24">
                        ...
                        <p class="mt-3 text-3xl font-extrabold text-white">Get actionable data that will help grow your
                            business</p>
                        <p class="mt-5 text-lg text-gray-300">Rhoncus sagittis risus arcu erat lectus bibendum. Ut in
                            ...
                            amet. Sit in et vitae tortor, massa. Dapibus laoreet amet lacus nibh integer quis. Eu
                        ...
                        <div class="mt-12 grid grid-cols-1 gap-y-12 gap-x-6 sm:grid-cols-2">
                            ...
                            <p>
                                ...
                                <span class="mt-1 block text-base text-gray-300"><span
                                        class="font-medium text-white">Customer satisfaction</span> laoreet amet lacus
            ...
            <div class="bg-white">
                <div
                    ...
                    <h2 class="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                        ...
                        <span
                            class="block bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-transparent">Get
