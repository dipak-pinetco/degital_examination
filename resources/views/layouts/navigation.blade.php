            ...
            <nav class="mt-5 flex-1 px-2 space-y-1">
                ...
                @hasanyrole('teacher|admin')
                    ...
                    <a href="{{ route('examinations.index') }}"
                        class="{{ Route::is('examination*') ? 'bg-indigo-800 text-white' : 'text-white hover:bg-indigo-600 hover:bg-opacity-75' }} group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                        <!-- Heroicon name: outline/home -->
                        <i class="mr-3 flex-shrink-0 h-8 w-6 text-indigo-300 fa fa-graduation-cap fa-2x"
                            aria-hidden="true"></i>
                        {{ __('Examination') }}
